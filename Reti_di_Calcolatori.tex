...
Quando una stazione rileva una collisione, utilizzando vari meccanismi, duplica il $cw$ in modo che l'intervallo di causalità sia duplicato, in modo da rendere più 
